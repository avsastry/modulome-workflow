...
# To build the docker container, run docker build . -t <username>/<repo_name>:<version>
# Once you've tested the container and are ready to publish, run docker push <username>/<repo_name>:<version>

# Start with PyModulon base container
# Alternatively, you can start with this container (if you used R treemap)
# i.e. FROM avsastry/modulome-workflow
FROM sbrg/pymodulon
...
# If you use the avsastry/modulome-workflow base container, you can skip this
