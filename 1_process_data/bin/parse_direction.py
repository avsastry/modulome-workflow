...
if __name__ == '__main__':
    # Argument parsing
    p = argparse.ArgumentParser(description='Converts output of infer_experiment to argument for Rockhopper')
    p.add_argument('rseqc_out', type=str,
                   help='RSEQC output file')
    p.add_argument('layout', type=str,
                   help='Single-end (SINGLE) or Paired-end (PAIRED)')
    args = p.parse_args()
